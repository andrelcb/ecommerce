            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        <h2 class="footer-wid-title">Receba notificaçoes</h2>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2017 Nome empresa. <a href="http://www.hcode.com.br" target="_blank">www.empresa.com.br</a></p>
                    </div>
                </div>
